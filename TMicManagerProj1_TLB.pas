...
// File generated on 27.05.2003 11:08:10 from Type Library described below.

// ************************************************************************ //
// Type Lib: D:\users\Yastcher\work\MicManag\TMicManagerProj1.tlb
// IID\LCID: {2332B312-090C-41A8-8968-ADA8735B632B}\0
// Helpfile: 
// HelpString: TMicManagerProj1 Library
// Version:    1.0
// ************************************************************************ //
...
// *********************************************************************//
const
  LIBID_TMicManagerProj1: TGUID = '{2332B312-090C-41A8-8968-ADA8735B632B}';
  IID_ITMicManagerX: TGUID = '{0E484B71-CB64-4879-BE6C-C7C70FCCD410}';
  DIID_ITMicManagerXEvents: TGUID = '{0A9334B8-8CEA-4D90-849A-56DDB5BE4E67}';
  CLASS_TMicManagerX: TGUID = '{9F629905-AE85-47D5-AA65-F0CA5051B547}';
...
// *********************************************************************//
  ITMicManagerX = interface;
  ITMicManagerXDisp = dispinterface;
  ITMicManagerXEvents = dispinterface;

// *********************************************************************//
// Declaration of CoClasses defined in Type Library                     //
// (NOTE: Here we map each CoClass to its Default Interface)            //
// *********************************************************************//
  TMicManagerX = ITMicManagerX;


// *********************************************************************//
// Interface: ITMicManagerX
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {0E484B71-CB64-4879-BE6C-C7C70FCCD410}
// *********************************************************************//
  ITMicManagerX = interface(IDispatch)
    ['{0E484B71-CB64-4879-BE6C-C7C70FCCD410}']
...
// *********************************************************************//
// DispIntf:  ITMicManagerXEvents
// Flags:     (4096) Dispatchable
// GUID:      {0A9334B8-8CEA-4D90-849A-56DDB5BE4E67}
// *********************************************************************//
  ITMicManagerXEvents = dispinterface
    ['{0A9334B8-8CEA-4D90-849A-56DDB5BE4E67}']
...
// Control Name     : TTMicManagerX
// Help String      : TMicManagerX Control
// Default Interface: ITMicManagerX
// Def. Intf. DISP? : No
// Event   Interface: ITMicManagerXEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TTMicManagerXOnKeyPress = procedure(Sender: TObject; var Key: Smallint) of object;

  TTMicManagerX = class(TOleControl)
  private
    ...
    FOnKeyPress: TTMicManagerXOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: ITMicManagerX;
    function  GetControlInterface: ITMicManagerX;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: ITMicManagerX read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TTMicManagerXOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TTMicManagerX.InitControlData;
const
  ...
  CControlData: TControlData = (
    ClassID: '{9F629905-AE85-47D5-AA65-F0CA5051B547}';
    EventIID: '{0A9334B8-8CEA-4D90-849A-56DDB5BE4E67}';
    EventCount: 8;
...
procedure TTMicManagerX.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as ITMicManagerX;
  end;
...
function TTMicManagerX.GetControlInterface: ITMicManagerX;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents('ActiveX',[TTMicManagerX]);
end;
